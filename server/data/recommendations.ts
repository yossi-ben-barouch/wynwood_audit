...
export const recommendationsData: Recommendation[] = [
  {
    ...
    timeline: "Week 1-2",
    description:
      "Focus Alejandro 80% on shop revenue generation, transfer other properties to external agency, and hire VA team for operational tasks.",
    actions: [
    ...
    expectedOutcome:
      "Alejandro focuses on revenue-generating activities, operational velocity increases 3x, single point of failure eliminated",
  },
  {
    id: "rec-2",
    ...
    timeline: "Week 1-3",
    description:
      "Rebuild Google Ads structure with granular control, proper campaign types, and data-driven optimization.",
    actions: [
    ...
    expectedOutcome:
      "ROAS improves from 2X to 3.5X+, CPA decreases 40%, wasted spend eliminated",
  },
  {
    id: "rec-3",
    ...
    timeline: "Week 0-3",
    description:
      "Expand to multiple marketplaces with automated product feeds to reach new audiences.",
    actions: [
    ...
    expectedOutcome:
      "400-600 SKUs live across marketplaces, $20-30K additional GMV in first 90 days",
  },
  {
    id: "rec-4",
    ...
    timeline: "Week 0-3",
    description:
      "Transform email from monthly blasts to strategic automated flows driving revenue.",
    actions: [
    ...
    expectedOutcome:
      "Email drives 7-10% of revenue during BFCM, ongoing 15% revenue contribution",
  },
  {
    id: "rec-5",
    ...
    expectedOutcome:
      "5-10K additional monthly shop visitors from museum traffic, improved SEO through internal linking",
  },
  {
    id: "rec-6",
    ...
    timeline: "Month 1-3",
    description:
      "Create weekly live shopping shows featuring artists and exclusive products.",
    actions: [
    ...
    expectedOutcome:
      "$3-5K GMV per episode, 5% opt-in rate from viewers, 30+ social content pieces per show",
  },
  {
    id: "rec-7",
    ...
    timeline: "Month 2-6",
    description:
      "Position fashion line as collectible wearable art with premium positioning and storytelling.",
    actions: [
    ...
    expectedOutcome:
      "Fashion positioned as premium collectible, wholesale channel established, 30% margins improve to 50%+",
  },
  {
    id: "rec-8",
    ...
    timeline: "Month 3-6",
    description:
      "Deploy AI tools to automate content creation, product optimization, and customer service.",
    actions: [
    ...
    expectedOutcome:
      "80% time savings on manual tasks, 10x content output, 24/7 customer support, data-driven design decisions",
  },
];
