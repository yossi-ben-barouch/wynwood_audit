    ...
    competencies: [
      {
        ...
        rating: 5,
        description:
          "Excellent execution; system stability relies on hands-on management",
      },
      {
        area: "Campaign Management",
        rating: 2,
        description:
          "Disorganized structure, limited testing, under-optimized targeting",
      },
      {
        area: "Strategic Planning",
        rating: 2,
        description:
          "Operates reactively; no documented growth roadmap or campaign hierarchy",
      },
      {
        area: "Delegation & SOPs",
        rating: 2,
        description:
          "Lack of workload orchestration & delegation; no SOPs or delegation",
      },
      {
        area: "Brand & Marketing Understanding",
        rating: 2,
        description: "Views e-commerce as transactional, not experiential",
      },
      {
        area: "Technical Skills",
        rating: 3.0,
        description:
          "Basic coding and systems integration capabilities, implementing AI and tools",
      },
    ],
