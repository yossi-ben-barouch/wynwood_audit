      ...
      <div className="max-w-7xl mx-auto px-8 py-6 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {data?.conversionMetrics?.map((metric, index) => (
            ...
            <>
              <KPICard label="Conversion Rate" value="0.8%" trend={-15} trendDirection="down" />
              <KPICard label="Domain Authority" value="72" trend={5} trendDirection="up" />
              <KPICard label="Monthly Traffic" value="250K" trend={12} trendDirection="up" />
            </>
          )}
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Current platforms and tools in use</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {data?.platforms.map((platform, index) => (
                ...
                >
                  ...
                  {platform.cost && (
                    <p className="text-xs font-mono text-primary">{platform.cost}</p>
                  )}
                </div>
              )) || (
                <>
                  <div className="p-4 rounded-lg border border-border">
                    ...
                    <p className="text-sm text-muted-foreground">Primary e-commerce platform</p>
                  </div>
                  <div className="p-4 rounded-lg border border-border">
                    <div className="flex items-start justify-between mb-2">
                    ...
                    <p className="text-sm text-muted-foreground">Point of sale system (95% of sales)</p>
                  </div>
                  <div className="p-4 rounded-lg border border-border">
                    <div className="flex items-start justify-between mb-2">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">Email marketing platform</p>
                    <p className="text-xs font-mono text-primary">$2,500/month</p>
                  </div>
                  <div className="p-4 rounded-lg border border-border">
                    <div className="flex items-start justify-between mb-2">
                    ...
                    <p className="text-sm text-muted-foreground">Traffic and behavior tracking</p>
                  </div>
                </>
              )}
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="mt-4 space-y-2">
                {data?.productCategories?.slice(0, 3).map((category, index) => (
                  <div key={index} className="flex justify-between items-center text-sm">
                    ...
                    <Badge variant="secondary">{category.margin || 'N/A'}</Badge>
                  </div>
                ))}
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Budget allocation and performance</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {data?.marketingChannels?.map((channel, index) => (
                  <div key={index} className="space-y-2 pb-4 border-b border-border last:border-0">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-mono text-sm text-primary">{channel.budget}</span>
                    </div>
                  ...
                  <>
                    <div className="space-y-2 pb-4 border-b border-border">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-mono text-sm text-primary">$3,000/mo</span>
                      </div>
                      <p className="text-sm text-muted-foreground">2X ROAS after account separation</p>
                    </div>
                    <div className="space-y-2 pb-4 border-b border-border">
                      <div className="flex justify-between items-center">
                        <h4 className="font-semibold">Meta/Facebook Ads</h4>
                        <span className="font-mono text-sm text-primary">$900/mo</span>
                      </div>
                      <p className="text-sm text-muted-foreground">Growing but underperforming</p>
                    </div>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <h4 className="font-semibold">Email Marketing</h4>
                        <span className="font-mono text-sm text-primary">$2,500/mo</span>
                      </div>
                      <p className="text-sm text-muted-foreground">350K list, low conversion</p>
                    </div>
                  </>
                )}
              </div>
